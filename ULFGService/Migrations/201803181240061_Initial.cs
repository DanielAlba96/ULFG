namespace ULFGService.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Title = c.String(),
                        Image = c.String(),
                        Member1_id = c.String(nullable: false, maxLength: 128),
                        Member2_id = c.String(nullable: false, maxLength: 128),
                        Version = c.Binary(nullable: false, fixedLength: true, timestamp: true, storeType: "rowversion",
                            annotations: new Dictionary<string, AnnotationValues>
                            {
                                { 
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Messages", "Creator_id", "dbo.Users");
            DropForeignKey("dbo.Messages", "Chat_id", "dbo.Chats");
            DropForeignKey("dbo.Messages", "Channel_id", "dbo.Channels");
            DropForeignKey("dbo.Chats", "Member2_id", "dbo.Users");
            DropForeignKey("dbo.Chats", "Member1_id", "dbo.Users");
            ...
            DropIndex("dbo.Chats", new[] { "CreatedAt" });
